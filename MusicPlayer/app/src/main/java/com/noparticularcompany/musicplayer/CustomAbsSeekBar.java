...
public abstract class CustomAbsSeekBar extends ProgressBar {
    ...
    public CustomAbsSeekBar(Context context) {
        super(context);
    }

    public CustomAbsSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomAbsSeekBar(Context context, AttributeSet attrs, int defStyle) {
